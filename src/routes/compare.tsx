...
function Row({
  ...
  return (
    <div
      className="rule-top grid grid-cols-1 gap-3 py-5 md:grid-cols-[13rem_minmax(0,1fr)]"
      data-reveal
    >
        ...
        <section className="border-b border-hairline bg-abyss">
          <div className="mx-auto max-w-7xl px-5 py-12 sm:px-8 md:py-16">
            ...
            <p className="mt-5 max-w-xl text-sm leading-relaxed text-muted-foreground">
              Rows line up so the difference between two records is visible instead of remembered.
              Where a record is silent, the row says so rather than filling the gap.
            </p>
          ...
          {cols.length === 0 ? (
            ...
            <div>
              ...
              <Row
                ...
                note="Filled only from the cited official-source domain."
              >
                {cols.map((c) => (
