    ...
    withIdentity(
      { path: "/" },
      {
        meta: [
          ...
          {
            name: "description",
            content: `A field guide for ${NAMED_WATER_COUNT} named public waters: readiness, ranking, and a printable brief.`,
          },
          {
            property: "og:title",
            content: "Field Sense Navigator · Read Public Waters Before You Go",
          },
          {
...
const READS = [
  [
    "River",
    "Current first.",
    "Seams, riffle-run-pool, outside bends, eddies and the wood that breaks the flow.",
  ],
  [
    "Lake",
    "Structure and edges.",
    "Points and bars, weed lines, the first drop-off, and any moving water at all.",
  ],
  [
    "Reservoir",
    "The drowned valley.",
    "The old river channel, standing timber, creek arms — and the level, which decides all of it.",
  ],
  [
    "Marine",
    "The tide, then the ground.",
    "Channels and guts, hard structure, rips and the bottom transitions the stage moves across.",
  ],
] as const;
...
const LAYERS = [
  [
    "Access & legality",
    "Published facilities, closures, directory-level networks, and the line where public corridor ends.",
  ],
  [
    "Conditions & hazards",
    "Standing hazard families the water is known for — wind fetch, tide, level swing, traffic. Never a forecast.",
  ],
  [
    "Capacity & crowding",
    "Documented pressure on parking, ramps and hours. Patterns, never live occupancy.",
  ],
  [
    "Seasonal & regulatory pressure",
    "Where rules move with date, section and vessel — and where jurisdiction changes under you.",
  ],
  [
    "Field-check requirement",
    "The same-day work you must complete. If a check is incomplete, treat the water as not ready to go.",
  ],
] as const;
      ...
      <main id="content">
        ...
        <section className="relative isolate overflow-hidden">
          ...
          <div className="mx-auto max-w-7xl px-safe pb-20 pt-28 sm:px-8 md:pb-28 md:pt-40 lg:pt-48">
            ...
            >
              Five planning layers over {NAMED_WATER_COUNT} named public waters. Name the job you
              are actually doing, and this guide ranks the water that fits it — then lists the
              same-day checks you have to clear before you go.
            </p>
        ...
        <section className="relative isolate overflow-hidden bg-abyss">
          ...
          <div className="mx-auto max-w-7xl px-safe py-24 sm:px-8 md:py-32">
            <div className="grid grid-cols-1 gap-14 lg:grid-cols-[0.9fr_1.1fr]">
              <div>
                <p className="tick text-brass" data-reveal>
                  What's in a reading
                </p>
                <h2
                ...
                <p
                  ...
                  style={{ "--reveal-delay": "160ms" } as React.CSSProperties}
                >
                  Every layer carries how sure we are and a list of what it still cannot see.
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1fr_1.15fr]">
            <div>
              ...
              <p
                ...
                style={{ "--reveal-delay": "160ms" } as React.CSSProperties}
              >
                Every record carries a standing read for its class of water — current and seams on a
                river, structure and edges on a lake, the old channel and the level on a reservoir,
                the tide across everything on the coast. It is craft, not a claim about conditions
                today, and it grows with you: three levels of detail, from the few features that
                matter most to the subtle reads.
              </p>
            </div>

            <ul
              className="grid grid-cols-1 gap-px self-start bg-hairline sm:grid-cols-2"
              data-reveal
        ...
        <section className="grid grid-cols-1 border-y border-hairline md:grid-cols-2">
          ...
          >
            ...
            <p
              className="mt-4 max-w-sm text-sm leading-relaxed text-foreground/80"
              data-reveal
              style={{ "--reveal-delay": "140ms" } as React.CSSProperties}
            >
              Bank, kayak, small boat, scouting, tournament-adjacent or a family day — with your
              time window, gear and wind tolerance applied before anything is ranked.
            </p>
            <span className="tick mt-6 inline-flex min-h-11 items-center text-primary group-hover:text-brass">
              Start the plan →
            </span>
          </Link>
          ...
          >
            ...
            <p
              ...
              style={{ "--reveal-delay": "140ms" } as React.CSSProperties}
            >
              {NAMED_WATER_COUNT} records across {states.length} states, provinces and territories,
              filtered by jurisdiction, water type and readiness band. Filter it down, or just read
              through it.
            </p>
            <span className="tick mt-6 inline-flex min-h-11 items-center text-primary group-hover:text-brass">
              Open the catalog →
        ...
        <section className="mx-auto max-w-7xl px-safe py-24 sm:px-8">
          <div className="flex flex-wrap items-end justify-between gap-6">
            ...
            <p className="max-w-sm text-xs leading-relaxed text-muted-foreground" data-reveal>
              Readiness measures how completely the record supports a decision — not how well the
              fishing will go. It never claims to know the water today.
            </p>
          </div>
        ...
        <section className="border-y border-hairline bg-abyss/50">
          <div className="mx-auto max-w-7xl px-safe py-20 sm:px-8 md:py-24">
            <div className="flex flex-wrap items-end justify-between gap-6">
              ...
              <p className="max-w-sm text-xs leading-relaxed text-muted-foreground" data-reveal>
                Pick a jurisdiction to open the catalog there. Coverage is uneven on purpose — a
                record only exists where an agency published enough to support one.
              </p>
            </div>
        ...
        <section className="relative isolate overflow-hidden border-y border-hairline bg-abyss">
          ...
          <div className="mx-auto grid grid-cols-1 max-w-7xl gap-12 px-safe py-24 sm:px-8 md:grid-cols-[1fr_1.1fr] md:py-32">
            <div>
              <p className="tick text-alert" data-reveal>
            ...
            <ul
              className="surface grid grid-cols-1 gap-px self-start bg-hairline sm:grid-cols-2"
              data-reveal
              style={{ "--reveal-delay": "120ms" } as React.CSSProperties}
            >
              {REFUSALS.map((r) => (
        ...
        {constrained && (
          <section className="mx-auto max-w-7xl px-safe py-24 sm:px-8">
            <div className="grid grid-cols-1 gap-10 md:grid-cols-[1fr_1fr] md:items-center">
              <div>
                <p className="tick text-watch" data-reveal>
                  Worked example
                </p>
                <h2
                ...
                <p
                  ...
                  style={{ "--reveal-delay": "160ms" } as React.CSSProperties}
                >
                  Low readiness does not mean stay home. It means the record cannot carry the
                  decision on its own, and the same-day checks are doing most of the work.
                </p>
              </div>
        ...
        <section className="relative isolate overflow-hidden border-t border-hairline">
          ...
          <div className="mx-auto max-w-7xl px-safe py-20 sm:px-8 md:py-28">
            ...
            <p
              ...
              style={{ "--reveal-delay": "120ms" } as React.CSSProperties}
            >
              Field Sense answers the first question in the Hook workflow. Open a record and every
              step below can be reached with this water's class, documented species, standing read
              and declared job already attached.
            </p>
            <ol
              className="mt-10 grid grid-cols-1 gap-px bg-hairline sm:grid-cols-2 lg:grid-cols-4"
              data-reveal
              style={{ "--reveal-delay": "160ms" } as React.CSSProperties}
            >
              {WORKFLOW.map((w, i) => {
