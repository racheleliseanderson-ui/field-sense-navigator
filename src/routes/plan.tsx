...
function Plan() {
  ...
  const result = useMemo(() => (job ? rank(destinations, job, c) : null), [job, c]);
        ...
        {search.job ? (
          <div className="border-b border-hairline bg-brass/10">
            <p className="mx-auto max-w-7xl px-5 py-3 text-sm leading-relaxed text-foreground sm:px-8">
              Quick readiness check. Job is declared{jobLabel ? ` (${jobLabel})` : ""}. Constraints
              stay optional. Ranked waters use documented records only — same-day checks are not
              invented.
            </p>
          </div>
        ) : null}
        ...
        >
          ...
          <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 md:py-24">
            ...
            <p className="mt-5 max-w-lg text-sm leading-relaxed text-muted-foreground">
              Ranking changes completely with the job. A water that is excellent for a trailered
              boat can be the wrong answer entirely for a kayak or a family afternoon.
            </p>
        ...
        <section hidden={step !== 2} className="border-b border-hairline bg-abyss">
          <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8">
            ...
            <p className="mt-3 max-w-2xl text-sm leading-relaxed text-muted-foreground">
              Optional. Rank with these defaults if you want the first useful list now. Widening
              later does not invent missing records.
            </p>
          ...
          {!job ? (
              ...
              <EmptyState
                ...
                action={
                  <div className="flex flex-wrap justify-center gap-4">
                    ...
                    <Link to="/plan" search={{ job: "bank", step: 3 }} className="tick text-brass">
            ...
            <div className="mt-8">
              <EmptyState
                ...
                action={
                  <button type="button" onClick={() => go({ step: 2 })} className="tick text-brass">
                    Change a constraint →
                  </button>
                }
              />
            ...
            <>
              <div className="mt-6 flex flex-wrap items-end justify-between gap-6">
                ...
                <p className="data text-xs text-muted-foreground">
                  {result.fits.length} fit · {result.excluded.length} excluded by required checks
                </p>
              </div>

              <p className="mt-3 max-w-2xl text-xs leading-relaxed text-muted-foreground">
                Fit score blends documented readiness with how well the record matches this job and
                these constraints. It is a documentation judgement, not a prediction about the day.
              </p>
              ...
              {result.fits[0] && (
                <div className="rule-top mt-12 pt-8">
                  ...
                  <p className="mt-3 max-w-2xl text-sm leading-relaxed text-muted-foreground">
                    A ranking is not a decision. Put the shortlist side by side, or take the top
                    record straight to a same-day brief — then hand the water to the instrument that
                  ...
                  <div className="mt-5 flex flex-wrap gap-3">
                    <button
                      type="button"
                      onClick={() =>
                        setCompare(result.fits.slice(0, COMPARE_LIMIT).map((f) => f.destination.id))
                      }
              ...
              {result.excluded.length > 0 && (
                <div className="mt-16">
                  ...
                  <p className="mt-3 max-w-2xl text-xs leading-relaxed text-muted-foreground">
                    These waters are not ranked because a required check could not be cleared from
                    the record. They are shown so the exclusion is visible rather than silent.
                  </p>
